...
export class DeathCertificateGenerator {
  ...
  private generateFromTemplate(deathRecord: DeathRecordInput): void {
    try {
      ...
      this.downloadCertificate(templateData, deathRecord);
   ...
   */
  private downloadCertificate(data: DeathCertificateData, deathRecord: DeathRecordInput): void {
    const filename = this.generateFilename(data, deathRecord);
   ...
   */
  private generateFilename(data: DeathCertificateData, deathRecord: DeathRecordInput): string {
